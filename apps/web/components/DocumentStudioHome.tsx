...
const templates: Template[] = [
  ...
  { key: "formal_letter", title: "Formal letter", description: "Professional correspondence using the approved Guardrisk letterhead, footer, signature and stamp layout.", category: "Popular", badge: "Most used", style: "guardrisk_orange", html: "<p>Dear Recipient Name,</p><p>Type your letter here.</p>" },
